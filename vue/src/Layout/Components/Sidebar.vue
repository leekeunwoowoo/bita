    ...
    <div class="app-sidebar sidebar-shadow" @mouseover="toggleSidebarHover('add','closed-sidebar-open')" @mouseleave="toggleSidebarHover('remove','closed-sidebar-open')">
        <div class="app-header__logo">
            ...
            <div class="header__pane ml-auto">
                <button type="button" class="hamburger close-sidebar-btn hamburger--elastic" v-bind:class="{ 'is-active' : false }" @click="toggleBodyClass('closed-sidebar')">
        ...
        <div class="app-sidebar-content">
            <VuePerfectScrollbar class="app-sidebar-scroll" v-once>
                <sidebar-menu showOneChild :menu="menu" @itemClick="onItemClick"/>
            </VuePerfectScrollbar>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            toggleSidebarHover(add, className) {
                console.log("toggleSidebarHover");
                const el = document.body;
