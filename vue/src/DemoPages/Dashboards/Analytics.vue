        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card-hover-shadow-2x mb-3 card">
                    ...
                    <div class="card-body">
                        <table aria-busy="false" aria-colcount="3" class="table b-table table-striped table-hover table-bordered border mb-0">
                            <!----><!---->
                            ...
                            <tbody role="rowgroup" class="">
								<tr role="row" class="" v-for="item in boardList" v-bind:key="item.aa" @click='toDetail(item.aa)'>
	                            	<td role="cell" aria-colindex="1" class="">{{item.bb}}</td>
	                            	<td role="cell" aria-colindex="1" class="">{{item.cc}}</td>
	                            	<td role="cell" aria-colindex="1" class="">{{item.dd}}</td>
					            </tr>
                            </tbody>
                        </table>
                    </div>
