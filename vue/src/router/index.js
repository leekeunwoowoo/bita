...
export default new Router({
    ...
    routes: [
        ...
        // Boards
        {
            path: '/boards/BoardMain',
            name: 'Qna Board',
            component: () => import('../DemoPages/Boards/BoardMain.vue'),
        },
        {
            path: '/Portfolio/portfolioMain',
            name: 'portfolioMain',
            component: () => import('../DemoPages/Portfolio/portfolioMain.vue'),
        },
    ]
})
